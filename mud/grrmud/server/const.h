...
#define BAG_FLAGS       ob->bag->bag_flags
#define OBJ_PRCNT_LOAD	ob->extras[2]
//#define OBJ_CUR_IN_GAME ob->extras[3]
#define OBJ_MAX_IN_GAME ob->extras[4]
#define OBJ_IN_ZONE	ob->cur_stats[3]
#define CASTS_THESE_SPELLS   ob->obj_proc->casts_these_spells
#define COMPONENT_ITEM1 ob->obj_proc->construct_data->item1
#define COMPONENT_ITEM2 ob->obj_proc->construct_data->item2
#define COMPONENT_ITEM3 ob->obj_proc->construct_data->item3
#define COMPONENT_ITEM4 ob->obj_proc->construct_data->item4
#define COMPONENT_ITEM5 ob->obj_proc->construct_data->item5
#define COMPONENT_TARG  ob->obj_proc->construct_data->target_object
#define OBJ_PRICE	ob->cur_stats[1]
#define OBJ_FLAGS	ob->obj_flags
#define OBJ_SPEC_FLAGS	ob->obj_proc->obj_spec_data_flags
#define OBJ_VIS_BIT	ob->cur_stats[0]
#define IN_LIST		ob->in_list
#define OBJ_CUR_WEIGHT	ob->cur_weight()
#define OBJ_MAX_WEIGHT	ob->max_weight()
#define OBJ_NUM		ob->cur_stats[2]
#define CHARGES			ob->extras[0]
#define RECHARGE       		ob->extras[1]
#define OBJ_BASE_WEIGHT		ob->extras[5]
#define OBJ_DAM_DICE_SIDES	ob->extras[6]
#define OBJ_DAM_DICE_COUNT	ob->extras[7]
#define OBJ_LEVEL		ob->extras[8]
#define OBJ_CONTAINER		54
#define OBJ_LIGHT_SOURCE	58
#define PRICE			ob->cur_stats[1]
...
#define CRIT_WT_CARRIED  	 cur_weight()
#define CRIT_MAX_WT_CARRY    	 max_weight()
